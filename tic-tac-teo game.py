...
pygame.display.set_caption('Tic-Tac-Teo AI')
screen.fill(BLACK)
    ...
    for row in range (BOARD_ROWS):
        for col in range (BOARD_COLS):
            if board[row][col] == 1:
                ...
                pygame.draw.line(screen, color, start_pos=(col* SQUARE_SIZE + SQUARE_SIZE // 4, row * SQUARE_SIZE + 3 * SQUARE_SIZE // 4), end_pos=(col * SQUARE_SIZE + SQUARE_SIZE // 4, row * SQUARE_SIZE + 3 * SQUARE_SIZE // 4 ), width=CROSS_WIDTH )
